...
module.exports = {
    ...
    partial_request_options: {
        // no copy_part_size_bytes, no copied_object_permissions, no expiration_period,  no server_side_encryption, no content_type
        source_bucket: "source_bucket",
        object_key: "object_key",
        destination_bucket: "destination_bucket",
        copied_object_name: "copied_object_name",
    ...
    createMultipartUploadStub_positive_response: Promise.resolve({
        UploadId: "1a2b3c4d",
    }),
    completeMultipartUploadStub_positive_response: Promise.resolve(),
    all_stubs_error_response: Promise.reject("test_error"),
    abortMultipartUploadStub_positive_response: Promise.resolve({}),
    listPartsStub_positive_response: Promise.resolve({ Parts: [] }),
    listPartsStub_negative_response: Promise.resolve({
        Parts: ["part 1", "part 2"],
    }),
